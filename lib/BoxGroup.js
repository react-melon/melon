(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', 'react', './boxgroup/Option', 'melon-core/classname/cxBuilder', 'melon-core/InputComponent', './babelHelpers'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('react'), require('./boxgroup/Option'), require('melon-core/classname/cxBuilder'), require('melon-core/InputComponent'), require('./babelHelpers'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.react, global.Option, global.cxBuilder, global.InputComponent, global.babelHelpers);
        global.BoxGroup = mod.exports;
    }
})(this, function (exports, _react, _Option, _cxBuilder, _InputComponent2, babelHelpers) {
    'use strict';
    ...
    BoxGroup.propTypes = babelHelpers['extends']({}, _InputComponent3['default'].propTypes, {
        ...
        value: function value() {
            ...
            return (_InputComponent$propT = _InputComponent3['default'].propTypes).value.apply(_InputComponent$propT, arguments) && _react.PropTypes.arrayOf(_react.PropTypes.string).apply(undefined, arguments);
        },
