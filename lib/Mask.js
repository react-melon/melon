(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', 'react', 'prop-types', 'melon-core/classname/cxBuilder', './dialog/windowScrollHelper', 'lodash/omit', './babelHelpers'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('react'), require('prop-types'), require('melon-core/classname/cxBuilder'), require('./dialog/windowScrollHelper'), require('lodash/omit'), require('./babelHelpers'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.react, global.propTypes, global.cxBuilder, global.windowScrollHelper, global.omit, global.babelHelpers);
        global.Mask = mod.exports;
    }
})(this, function (exports, _react, _propTypes, _cxBuilder, _windowScrollHelper, _omit, babelHelpers) {
    'use strict';
    ...
    Mask.propTypes = {
        lockScrollingOnShow: _propTypes2['default'].bool,
