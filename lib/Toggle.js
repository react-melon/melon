(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', 'react', 'prop-types', 'melon-core/InputComponent', 'melon-core/classname/cxBuilder', './ripples/CenterRipple', './babelHelpers'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('react'), require('prop-types'), require('melon-core/InputComponent'), require('melon-core/classname/cxBuilder'), require('./ripples/CenterRipple'), require('./babelHelpers'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.react, global.propTypes, global.InputComponent, global.cxBuilder, global.CenterRipple, global.babelHelpers);
        global.Toggle = mod.exports;
    }
})(this, function (exports, _react, _propTypes, _InputComponent2, _cxBuilder, _CenterRipple, babelHelpers) {
    'use strict';
    ...
    Toggle.propTypes = babelHelpers['extends']({}, _InputComponent3['default'].propTypes, {
        trueValue: _propTypes2['default'].any.isRequired
    });
