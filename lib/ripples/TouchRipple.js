(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', 'react', 'prop-types', 'react-dom', './RippleCircle', '../common/util/dom', 'melon-core/classname/cxBuilder', 'react-motion', '../babelHelpers'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('react'), require('prop-types'), require('react-dom'), require('./RippleCircle'), require('../common/util/dom'), require('melon-core/classname/cxBuilder'), require('react-motion'), require('../babelHelpers'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.react, global.propTypes, global.reactDom, global.RippleCircle, global.dom, global.cxBuilder, global.reactMotion, global.babelHelpers);
        global.TouchRipple = mod.exports;
    }
})(this, function (exports, _react, _propTypes, _reactDom, _RippleCircle, _dom, _cxBuilder, _reactMotion, babelHelpers) {
    'use strict';
    ...
    var TouchRipple = function (_Component) {
        ...
        TouchRipple.prototype.render = function render() {
            ...
            var _state = this.state,
                _state$center = _state.center,
                centerX = _state$center[0],
                centerY = _state$center[1],
                now = _state.now;
    ...
    TouchRipple.propTypes = {
        ...
        onMotionEnd: _propTypes2['default'].func
    };
});
