(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', 'react', 'prop-types', 'react-dom', 'melon-core/InputComponent', 'melon-core/classname/cxBuilder', './slider/Bar', './slider/getNewValue', './babelHelpers'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('react'), require('prop-types'), require('react-dom'), require('melon-core/InputComponent'), require('melon-core/classname/cxBuilder'), require('./slider/Bar'), require('./slider/getNewValue'), require('./babelHelpers'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.react, global.propTypes, global.reactDom, global.InputComponent, global.cxBuilder, global.Bar, global.getNewValue, global.babelHelpers);
        global.Slider = mod.exports;
    }
})(this, function (exports, _react, _propTypes, _reactDom, _InputComponent2, _cxBuilder, _Bar, _getNewValue, babelHelpers) {
    'use strict';
    ...
    Slider.propTypes = babelHelpers['extends']({}, _InputComponent3['default'].propTypes, {
        ...
        pointerSize: _propTypes2['default'].oneOfType([_propTypes2['default'].number, _propTypes2['default'].string])
    });
});
