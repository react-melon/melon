(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', 'react', 'react-dom', 'melon-core/InputComponent', 'melon-core/classname/cxBuilder', './common/util/dom', './slider/Bar', './slider/getNewValue', './babelHelpers'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('react'), require('react-dom'), require('melon-core/InputComponent'), require('melon-core/classname/cxBuilder'), require('./common/util/dom'), require('./slider/Bar'), require('./slider/getNewValue'), require('./babelHelpers'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.react, global.reactDom, global.InputComponent, global.cxBuilder, global.dom, global.Bar, global.getNewValue, global.babelHelpers);
        global.Slider = mod.exports;
    }
})(this, function (exports, _react, _reactDom, _InputComponent2, _cxBuilder, _dom, _Bar, _getNewValue, babelHelpers) {
    'use strict';
