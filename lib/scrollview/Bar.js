(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', 'react', 'melon-core/classname/cxBuilder', '../common/util/dom', '../common/util/fn', '../babelHelpers'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('react'), require('melon-core/classname/cxBuilder'), require('../common/util/dom'), require('../common/util/fn'), require('../babelHelpers'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.react, global.cxBuilder, global.dom, global.fn, global.babelHelpers);
        global.Bar = mod.exports;
    }
})(this, function (exports, _react, _cxBuilder, _dom, _fn, babelHelpers) {
    'use strict';
    ...
    ScrollViewBar.propTypes = {
        direction: _react.PropTypes.oneOf(['vertical', 'horizontal']).isRequired,
