(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', 'react', 'prop-types', 'melon-core/classname/cxBuilder', './ripples/TouchRipple', 'lodash/omit', './babelHelpers'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('react'), require('prop-types'), require('melon-core/classname/cxBuilder'), require('./ripples/TouchRipple'), require('lodash/omit'), require('./babelHelpers'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.react, global.propTypes, global.cxBuilder, global.TouchRipple, global.omit, global.babelHelpers);
        global.Button = mod.exports;
    }
})(this, function (exports, _react, _propTypes, _cxBuilder, _TouchRipple, _omit, babelHelpers) {
    'use strict';
