(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', 'react', 'prop-types', 'react-dom', './Mask', './common/util/dom', './dialog/DialogWindow', './Layer', 'melon-core/classname/cxBuilder', 'react-motion', './babelHelpers'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('react'), require('prop-types'), require('react-dom'), require('./Mask'), require('./common/util/dom'), require('./dialog/DialogWindow'), require('./Layer'), require('melon-core/classname/cxBuilder'), require('react-motion'), require('./babelHelpers'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.react, global.propTypes, global.reactDom, global.Mask, global.dom, global.DialogWindow, global.Layer, global.cxBuilder, global.reactMotion, global.babelHelpers);
        global.Dialog = mod.exports;
    }
})(this, function (exports, _react, _propTypes, _reactDom, _Mask, _dom, _DialogWindow, _Layer, _cxBuilder, _reactMotion, babelHelpers) {
    'use strict';
    ...
    Dialog.propTypes = {
        ...
        maskClickClose: _propTypes2['default'].bool,
