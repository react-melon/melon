(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', 'react', 'react-dom', './Mask', './common/util/dom', './dialog/DialogWindow', 'lodash/omit', 'melon-core/classname/cxBuilder', 'react-motion', './babelHelpers'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('react'), require('react-dom'), require('./Mask'), require('./common/util/dom'), require('./dialog/DialogWindow'), require('lodash/omit'), require('melon-core/classname/cxBuilder'), require('react-motion'), require('./babelHelpers'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.react, global.reactDom, global.Mask, global.dom, global.DialogWindow, global.omit, global.cxBuilder, global.reactMotion, global.babelHelpers);
        global.Dialog = mod.exports;
    }
})(this, function (exports, _react, _reactDom, _Mask, _dom, _DialogWindow, _omit, _cxBuilder, _reactMotion, babelHelpers) {
    'use strict';
