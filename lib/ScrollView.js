(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', 'react', 'prop-types', './scrollview/Bar', 'melon-core/classname/cxBuilder', './babelHelpers'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('react'), require('prop-types'), require('./scrollview/Bar'), require('melon-core/classname/cxBuilder'), require('./babelHelpers'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.react, global.propTypes, global.Bar, global.cxBuilder, global.babelHelpers);
        global.ScrollView = mod.exports;
    }
})(this, function (exports, _react, _propTypes, _Bar, _cxBuilder, babelHelpers) {
    'use strict';
    ...
    var ScrollView = function (_Component) {
        ...
        ScrollView.prototype.onAction = function onAction(direction, e) {
            ...
            switch (action) {
                case 'change':
                    this.setScrollPercent((_setScrollPercent = {}, _setScrollPercent[direction] = position, _setScrollPercent));
                    break;
            }
        };
        ...
        ScrollView.prototype.render = function render() {
            ...
            var className = cx(this.props).addVariants(this.getDirections()).build();
            ...
            return _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                    'div',
                    { ref: 'content', className: cx.getPartClassName('main') },
                    children
                )
            );
        };
    ...
    ScrollView.propTypes = {
        direction: _propTypes2['default'].oneOf(['vertical', 'horizontal', 'both']),
        wheelSpeed: _propTypes2['default'].number,
