(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', 'react', 'prop-types', '../Icon', './Column', '../babelHelpers'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('react'), require('prop-types'), require('../Icon'), require('./Column'), require('../babelHelpers'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.react, global.propTypes, global.Icon, global.Column, global.babelHelpers);
        global.SelectorColumn = mod.exports;
    }
})(this, function (exports, _react, _propTypes, _Icon, _Column, babelHelpers) {
    'use strict';
    ...
    TableSelectorColumn.propTypes = babelHelpers['extends']({}, _Column2['default'].propTypes, {
        ...
        isAllSelected: _propTypes2['default'].func.isRequired,
