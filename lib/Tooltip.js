(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', 'react', 'prop-types', 'melon-core/classname/cxBuilder', './Popover', './babelHelpers'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('react'), require('prop-types'), require('melon-core/classname/cxBuilder'), require('./Popover'), require('./babelHelpers'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.react, global.propTypes, global.cxBuilder, global.Popover, global.babelHelpers);
        global.Tooltip = mod.exports;
    }
})(this, function (exports, _react, _propTypes, _cxBuilder, _Popover, babelHelpers) {
    'use strict';
    ...
    Tooltip.propTypes = {
        direction: _propTypes2['default'].oneOf(['top', 'bottom', 'left', 'right']).isRequired,
        mode: _propTypes2['default'].oneOf(['over', 'click']),
