(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', 'react', 'prop-types', './Mask', 'melon-core/classname/cxBuilder', './common/util/dom', './babelHelpers'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('react'), require('prop-types'), require('./Mask'), require('melon-core/classname/cxBuilder'), require('./common/util/dom'), require('./babelHelpers'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.react, global.propTypes, global.Mask, global.cxBuilder, global.dom, global.babelHelpers);
        global.Drawer = mod.exports;
    }
})(this, function (exports, _react, _propTypes, _Mask, _cxBuilder, _dom, babelHelpers) {
    'use strict';
     ...
     */
    Drawer.propTypes = {
        position: _propTypes2['default'].oneOf(Object.keys(REVERT_POSITION)).isRequired,
