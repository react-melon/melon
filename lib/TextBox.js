(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', 'react', 'prop-types', 'react-dom', './textbox/FloatLabel', './textbox/Input', 'melon-core/InputComponent', 'melon-core/classname/cxBuilder', './babelHelpers'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('react'), require('prop-types'), require('react-dom'), require('./textbox/FloatLabel'), require('./textbox/Input'), require('melon-core/InputComponent'), require('melon-core/classname/cxBuilder'), require('./babelHelpers'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.react, global.propTypes, global.reactDom, global.FloatLabel, global.Input, global.InputComponent, global.cxBuilder, global.babelHelpers);
        global.TextBox = mod.exports;
    }
})(this, function (exports, _react, _propTypes, _reactDom, _FloatLabel, _Input, _InputComponent2, _cxBuilder, babelHelpers) {
    'use strict';
