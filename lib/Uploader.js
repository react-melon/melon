(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', 'react', 'prop-types', './Button', './Icon', './Progress', './Link', 'melon-core/InputComponent', './common/util/guid', 'melon-core/classname/cxBuilder', './babelHelpers'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('react'), require('prop-types'), require('./Button'), require('./Icon'), require('./Progress'), require('./Link'), require('melon-core/InputComponent'), require('./common/util/guid'), require('melon-core/classname/cxBuilder'), require('./babelHelpers'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.react, global.propTypes, global.Button, global.Icon, global.Progress, global.Link, global.InputComponent, global.guid, global.cxBuilder, global.babelHelpers);
        global.Uploader = mod.exports;
    }
})(this, function (exports, _react, _propTypes, _Button, _Icon, _Progress, _Link, _InputComponent2, _guid, _cxBuilder, babelHelpers) {
    'use strict';
            ...
            switch (status) {
                ...
                case 'fulfilled':
                    return _react2['default'].createElement(
                        ...
                        fileType === 'image' ? _react2['default'].createElement('img', {
                            className: cx.getPartClassName('preview'),
                            src: value }) : _react2['default'].createElement(_Icon2['default'], { icon: 'folder' }),
    ...
    Uploader.propTypes = babelHelpers['extends']({}, _InputComponent3['default'].propTypes, {
        ...
        fileType: _propTypes2['default'].oneOf(['image', 'all']),

        value: controlledCheck(_propTypes2['default'].string),
        uploading: controlledCheck(_propTypes2['default'].bool),
        onFileChange: controlledCheck(_propTypes2['default'].func),

        defaultValue: uncontrolledCheck(_InputComponent3['default'].propTypes.defaultValue),
        upload: uncontrolledCheck(_propTypes2['default'].func),
        onUploadStart: uncontrolledCheck(_propTypes2['default'].func),
        onUploadSucceed: uncontrolledCheck(_propTypes2['default'].func),
        onUploadFailed: uncontrolledCheck(_propTypes2['default'].func)
