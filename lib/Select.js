(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', 'react', 'prop-types', './Icon', 'melon-core/InputComponent', './select/OptionGroup', './select/Option', 'melon-core/classname/cxBuilder', './Popover', './babelHelpers'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('react'), require('prop-types'), require('./Icon'), require('melon-core/InputComponent'), require('./select/OptionGroup'), require('./select/Option'), require('melon-core/classname/cxBuilder'), require('./Popover'), require('./babelHelpers'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.react, global.propTypes, global.Icon, global.InputComponent, global.OptionGroup, global.Option, global.cxBuilder, global.Popover, global.babelHelpers);
        global.Select = mod.exports;
    }
})(this, function (exports, _react, _propTypes, _Icon, _InputComponent2, _OptionGroup, _Option, _cxBuilder, _Popover, babelHelpers) {
    'use strict';
    ...
    var Select = function (_InputComponent) {
        ...
        function Select(props, context) {
            ...
            _this.scrollSelectedOptionInView = _this.scrollSelectedOptionInView.bind(_this);
        ...
        Select.prototype.scrollSelectedOptionInView = function scrollSelectedOptionInView() {
            ...
            var selectedOptionElement = layer.querySelector('[data-value="' + value + '"]');
    ...
    Select.propTypes = babelHelpers['extends']({}, _InputComponent3['default'].propTypes, {
        ...
        layerArchor: _propTypes2['default'].oneOf(_Popover.alignments),
        mainArchor: _propTypes2['default'].oneOf(_Popover.alignments),
