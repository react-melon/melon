(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', 'react', 'prop-types', 'melon-core/classname/cxBuilder', './Selector', './Province', './City', './helper', '../babelHelpers'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('react'), require('prop-types'), require('melon-core/classname/cxBuilder'), require('./Selector'), require('./Province'), require('./City'), require('./helper'), require('../babelHelpers'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.react, global.propTypes, global.cxBuilder, global.Selector, global.Province, global.City, global.helper, global.babelHelpers);
        global.Area = mod.exports;
    }
})(this, function (exports, _react, _propTypes, _cxBuilder, _Selector, _Province, _City, _helper, babelHelpers) {
    'use strict';
