(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', 'react', 'prop-types', './Menu', './Popover', 'melon-core/classname/cxBuilder', './babelHelpers'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('react'), require('prop-types'), require('./Menu'), require('./Popover'), require('melon-core/classname/cxBuilder'), require('./babelHelpers'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.react, global.propTypes, global.Menu, global.Popover, global.cxBuilder, global.babelHelpers);
        global.DropDownMenu = mod.exports;
    }
})(this, function (exports, _react, _propTypes, _Menu, _Popover, _cxBuilder, babelHelpers) {
    'use strict';
