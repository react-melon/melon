(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', 'react', 'prop-types', './Table', './table/SelectorColumn', './table/SelectorRow', './babelHelpers'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('react'), require('prop-types'), require('./Table'), require('./table/SelectorColumn'), require('./table/SelectorRow'), require('./babelHelpers'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.react, global.propTypes, global.Table, global.SelectorColumn, global.SelectorRow, global.babelHelpers);
        global.SelectableTable = mod.exports;
    }
})(this, function (exports, _react, _propTypes, _Table2, _SelectorColumn, _SelectorRow, babelHelpers) {
    'use strict';
    ...
    SelectableTable.propTypes = babelHelpers['extends']({}, _Table3['default'].propTypes, {
        ...
        selected: _propTypes2['default'].arrayOf(_propTypes2['default'].number).isRequired
    });
