(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', 'react', 'react-motion', '../common/util/dom', 'melon-core/classname/cxBuilder', '../babelHelpers'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('react'), require('react-motion'), require('../common/util/dom'), require('melon-core/classname/cxBuilder'), require('../babelHelpers'));
    } else {
        var mod = {
            exports: {}
        };
    ...
    var SelectSeparatePopup = function (_Component) {
        ...
        SelectSeparatePopup.prototype.getStyle = function getStyle(open) {
            ...
            var _main$style = main.style,
                top = _main$style.top,
                left = _main$style.left,
                width = _main$style.width,
                height = _main$style.height,
                overflow = _main$style.overflow;
...
//# sourceMappingURL=SeparatePopup.js.map
