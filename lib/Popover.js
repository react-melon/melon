(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', 'react', 'prop-types', './Layer', 'dom-align', 'react-motion', './common/util/fn', './common/util/dom', 'melon-core/classname/cxBuilder', './babelHelpers'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('react'), require('prop-types'), require('./Layer'), require('dom-align'), require('react-motion'), require('./common/util/fn'), require('./common/util/dom'), require('melon-core/classname/cxBuilder'), require('./babelHelpers'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.react, global.propTypes, global.Layer, global.domAlign, global.reactMotion, global.fn, global.dom, global.cxBuilder, global.babelHelpers);
        global.Popover = mod.exports;
    }
})(this, function (exports, _react, _propTypes, _Layer, _domAlign, _reactMotion, _fn, _dom, _cxBuilder, babelHelpers) {
    'use strict';
    ...
    Popover.propTypes = {
        ...
        useLayerMask: _propTypes2['default'].bool,
        anchorAlignment: _propTypes2['default'].oneOf(alignments),
        layerAlignment: _propTypes2['default'].oneOf(alignments),
        anchorOffset: _propTypes2['default'].arrayOf(_propTypes2['default'].number),
        layerOffset: _propTypes2['default'].arrayOf(_propTypes2['default'].number),
