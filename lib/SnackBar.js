(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', 'react', 'prop-types', 'react-dom', './Button', 'melon-core/classname/cxBuilder', './babelHelpers'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('react'), require('prop-types'), require('react-dom'), require('./Button'), require('melon-core/classname/cxBuilder'), require('./babelHelpers'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.react, global.propTypes, global.reactDom, global.Button, global.cxBuilder, global.babelHelpers);
        global.SnackBar = mod.exports;
    }
})(this, function (exports, _react, _propTypes, _reactDom, _Button, _cxBuilder, babelHelpers) {
    'use strict';
    ...
    SnackBar.propTypes = {
        ...
        direction: _propTypes2['default'].oneOf(['tr', 'rt', 'rb', 'br', 'bl', 'lb', 'lt', 'tl', 'tc', 'rc', 'bc', 'lc'])
    };
