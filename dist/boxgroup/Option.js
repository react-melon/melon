...
(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', 'react', '../common/util/cxBuilder', '../Icon', '../ripples/CenterRipple', "../babelHelpers"], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('react'), require('../common/util/cxBuilder'), require('../Icon'), require('../ripples/CenterRipple'), require("../babelHelpers"));
    } else {
        var mod = {
            exports: {}
        };
