...
(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', 'react', 'melon-core/classname/cxBuilder', './Selector', './Province', './City', './helper', "../babelHelpers"], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('react'), require('melon-core/classname/cxBuilder'), require('./Selector'), require('./Province'), require('./City'), require('./helper'), require("../babelHelpers"));
    } else {
        var mod = {
            exports: {}
        };
